...
export class Album extends React.Component<IAlbumProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="album-heading">
          <Translate contentKey="reactMonolithApp.album.home.title">Albums</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="reactMonolithApp.album.home.createLabel">Create new Album</Translate>
          </Link>
        </h2>
