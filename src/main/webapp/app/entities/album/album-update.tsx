    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="reactMonolithApp.album.home.createOrEditLabel">
              <Translate contentKey="reactMonolithApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : albumEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="album-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="displayOrderLabel" for="displayOrder">
                    <Translate contentKey="reactMonolithApp.album.displayOrder">Display Order</Translate>
                  </Label>
                  <AvField id="album-displayOrder" type="number" className="form-control" name="displayOrder" />
                </AvGroup>
